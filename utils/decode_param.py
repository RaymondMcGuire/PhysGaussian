...
def decode_param_json(json_file):
    ...
    if "disable_transform" in sim_params.keys():
        preprocessing_params["disable_transform"] = sim_params["disable_transform"]
    else:
        preprocessing_params["disable_transform"] = False
